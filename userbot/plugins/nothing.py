...
List of included ASCII arts:
 mf  (Middle Finger)
 dislike  (I hate it, boo)
 chess  (Try playing chess!)
 shitos  (Official logo for ShitOS) :P
 qrcode  (Scan the QR Code from the UPI app)
 youjoined  (You joined? I.... :)"""