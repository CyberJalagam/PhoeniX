...
async def upstream(ups):
    ...
    if HEROKU_API_KEY != None:
        ...
        await ups.edit(
            ...
            'UserBot is restarting... Wait for a few seconds, then '
            'check if UserBot is alive by using the ".ping" command.`')
...
\n\n• `.update now`\
\nUsage: __Downloads and Install the OTA Update__\
"
})
